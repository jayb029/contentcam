...
2. To create a test build, open **Actions > Nightly Release**, click **Run workflow**, choose the source branch with **Use workflow from**, and run it. Choose `main` when you want a Nightly from the production branch.
